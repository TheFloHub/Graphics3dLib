...
void G3d::InputManager::cursorPositionCallback(GLFWwindow * window, double xpos, double ypos)
{
...
double G3d::InputManager::getMouseDeltaX() const
{
	return mDiffX;
}

double G3d::InputManager::getMouseDeltaY() const
{
	return mDiffY;
}
